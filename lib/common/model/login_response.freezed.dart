...
abstract class $LoginResponseCopyWith<$Res> {
  ...
  @useResult
  $Res call({String accessToken, String memberStatus});
}
...
class _$LoginResponseImpl
  ...
  const _$LoginResponseImpl(
      {required this.accessToken, required this.memberStatus});
  ...
  String toString({DiagnosticLevel minLevel = DiagnosticLevel.info}) {
    return 'LoginResponse(accessToken: $accessToken, memberStatus: $memberStatus)';
  }
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    ...
    properties
      ...
      ..add(DiagnosticsProperty('memberStatus', memberStatus));
  }
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, accessToken, memberStatus);
...
abstract class _LoginResponse implements LoginResponse {
  const factory _LoginResponse(
      ...
      required final String memberStatus}) = _$LoginResponseImpl;
